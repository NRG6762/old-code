...
@Autonomous(name="Indie: Autonomous Blue B", group="#No Jewel")
public class IndieAutonomousBlueB extends IndieAutonomousBase {
            ...
            switch (currMainTask){
                ...
                case "Step 3":
                    ...
                    if(VuMark.equals("LEFT") || VuMark.equals("Un-identified") ) {
                        if(indie.DrivePos1.getCurrentPosition() >= -50) {
                            mecanum(-.5, 0, -correction(startHeading, currentHeading));
                        }else{
                            stopMotors();
                            resetEncoders();
                        ...
                        if(indie.DrivePos1.getCurrentPosition()<= 550) {
                            mecanum(.5, 0 ,  -correction(startHeading,currentHeading));
                        }else{
                            stopMotors();
                            resetEncoders();
                        ...
                        if(indie.DrivePos1.getCurrentPosition()<= 1150) {
                            mecanum(.5, 0 , -correction(startHeading,currentHeading));
                        }else{
                            stopMotors();
                            resetEncoders();
                ...
                case "Step 6":
                    if((prevStartPos - indie.DrivePos1.getCurrentPosition()) < 600) {
                        mecanum(-.4, 0, 0);
                    } else {
                        mecanum(0, 0, 0);
