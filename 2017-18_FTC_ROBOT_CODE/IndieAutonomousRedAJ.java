...
@Autonomous(name="Indie: Autonomous Red A Jewel", group="Jewel")
public class IndieAutonomousRedAJ extends IndieAutonomousBase {
    ...
    private boolean jewelStart = true;
    private double jewelTime = 0.0;
        ...
        while (opModeIsActive()) {
            ...
            switch (currMainTask){
                ...
                case "Step 2":
                    ...
                    switch(jewelFinder("Right", jewelTime, loopTime)){

                        case "red":
                            if(turnAndBack("back", jewelTime, loopTime)){
                                if(loopTime - jewelTime >= 6) currMainTask = "Step 3";
                            }
                            break;

                        case "blue":
                            if(turnAndBack("front", jewelTime, loopTime)){
                                if(loopTime - jewelTime >= 6) currMainTask = "Step 3";
                            }
                            break;
