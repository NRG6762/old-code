...
//@Disabled
public class RoverAutonomousDepot extends LinearOpMode {
    ...
    private int liftTotalMove = 12000;
        ...
        while (opModeIsActive()) {
            ...
            if (robot.tfod != null) {
                ...
                if (goldObj && !goldPos.equals("UNKNOWN")) {
                    ...
                    } else if ((lightRun >= 500) && (lightRun < 1000)) {
                        //robot.light.setPower(1);
                    } else if ((lightRun >= 1000) && (lightRun < 1500)) {
                        //robot.light.setPower(0);
                    } else if ((lightRun >= 1500) && (lightRun < 2000)) {
                        //robot.light.setPower(1);
                    } else {
                        //robot.light.setPower(0);
                    }
