...
@Autonomous(name="DO NOT USE: Autonomous: Crater", group="Autonomous Testing")
//@Disabled
public class RoverAutonomousCraterTesting extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (stage) {
                ...
                case "Mineral: Move Out":
                    speed = driveCurve(2400, robot.drive1.getCurrentPosition(), .8);
                ...
                case "Return to Crater":
                    speed = driveCurve(5000, robot.drive1.getCurrentPosition(), 1);
                    robot.drive1.setPower(speed);
                    robot.drive2.setPower(0);
                    robot.drive3.setPower(-speed);
                    robot.drive4.setPower(0);
            ...
            telemetry.addData("Total Rotations", infOrient);

            telemetry.addData("Current Gold Mineral Position", goldPos);
