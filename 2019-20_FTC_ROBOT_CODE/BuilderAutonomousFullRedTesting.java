 ...
 */
@Autonomous(name="Testing: Builder Autonomous - Full Red", group="Testing")
//@Disabled
public class BuilderAutonomousFullRedTesting extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (driveStep) {
                ...
                case "Crab Along Stones 1":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.leftFront.getCurrentPosition(), robot.ticksPerInchSide * 4, 1),
