 ...
 */
@Autonomous(name="Builder Autonomous - Full Blue", group= "Competition")
//@Disabled
public class BuilderAutonomousFullBlue extends LinearOpMode {
    ...
    private int foundationDistanceHold = 0;
        ...
        while (opModeIsActive()) {
            ...
            switch (driveStep) {
                ...
                case "Move Foundation":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.leftFront.getCurrentPosition(), robot.ticksPerInchSide * (distanceHold + 30), 1),
            ...
            switch(stoneStep){
                ...
                case "Uppy":
                    ...
                    if(scissorControl(true, robot.rotatorMidPosition, 3, 0)){
