 ...
 */
@TeleOp(name="Builder Tele-Op Half", group="Competition")
//@Disabled
public class BuilderTeleOpHalf extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(robot.driveMotorsTrue){
                ...
                double polarSpeed = Math.sqrt((gamepad1.left_stick_y * gamepad1.left_stick_y) + (gamepad1.left_stick_x * gamepad1.left_stick_x)) / 2;
