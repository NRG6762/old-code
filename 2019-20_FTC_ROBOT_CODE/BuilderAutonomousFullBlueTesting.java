 ...
 */
@Autonomous(name="Testing: Builder Autonomous - Full Blue", group= "Testing")
//@Disabled
public class BuilderAutonomousFullBlueTesting extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (driveStep) {
                ...
                case "To Stones":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.leftFront.getCurrentPosition(), robot.ticksPerInchFront * distanceHold, 1),
                            0, -correction(startOrient, currOrient))){

                        stopAndResetMotors();

                        driveStep = "Crab Along Stones 3";
                ...
                case "Crab Along Stones 1":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.rightFront.getCurrentPosition(), robot.ticksPerInchSide * 4, 1),
                        ...
                        if(skystoneSeen){
                            ...
                            driveStep = "Crab Along Stones 2";
                        }

                        foundationDistanceHold += 4;
                ...
                case "Grab Stone 1":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.leftFront.getCurrentPosition(), robot.ticksPerInchFront * (distanceHold - robot.backGripper), 1),
                            0, -correction(startOrient, currOrient))){
                ...
                case "Align to Foundation":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.leftFront.getCurrentPosition(), robot.ticksPerInchSide * (48 - foundationDistanceHold), 1),
                            Math.PI / 2, -correction(startOrient, currOrient))){
                ...
                case "Crab Return":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.leftFront.getCurrentPosition(), robot.ticksPerInchSide * 96, 1),
                            Math.PI / 2, -correction(startOrient, currOrient))){
                ...
                case "Move Foundation":
                    ...
                    if(newDriveCommand(motorCurve(ticksHold, robot.rightFront.getCurrentPosition(), robot.ticksPerInchSide * (distanceHold + 30), 1),
                            Math.PI, -correction(startOrient, currOrient))){
            ...
            switch(stoneStep){
                ...
                case "Start":
                    ...
                    if(scissorControl(false, robot.rotatorMidPosition, robot.gripperClearing + 2, 0)){
                        driveStep = "To Stones";
                        stoneStep = "Hold";
                        firstTimeStone = true;
                    }
    ...
    private boolean scissorControl(boolean grip, double rotatorPosition, double scissorHeight, double linearPosition){
        ...
        if(!robot.limitLower.getState() || scissorHeight == 0 || Math.abs(currHeight - scissorHeight) < robot.distanceRange){
            robot.scissor.setPower(0);
        }
        ...
        return Math.abs(currHeight - scissorHeight) < robot.distanceRange || !robot.limitLower.getState() /*&& Math.abs(robot.linear.getCurrentPosition() - (linearPosition * robot.ticksPerLinearInch)) <= 20*/;
